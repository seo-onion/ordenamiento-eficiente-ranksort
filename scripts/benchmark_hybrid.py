...
def run_experiment(algorithm, size_label, N, distribution, mpi_ranks, omp_threads, iterations=3):
    ...
    cmd.extend([bin_path, data_file, str(N)])
...
def main():
    ...
    csv_file = "results/benchmark_hybrid_results_kipu.csv" if args.kipu else "results/benchmark_hybrid_results.csv"
    ...
    if args.kipu:
        configs = [
            (2, 2), (2, 4), (2, 8), (4, 2), (4, 4), (4, 8), (8, 2), (8, 4)
        ]
    else:
        configs = [
            (1, 2), (1, 4), (1, 8), (2, 2), (2, 4), (4, 2)
        ]
    ...
    algorithms = ["hybrid_ranksort", "hybrid_quicksort"]
    ...
    print(f"\n¡Pruebas Híbridas completadas! Resultados guardados en {csv_file}")
